  ...
  return (
    <section className="section4">
      <div className="public">
        ...
        <div id="publicsafety">
          <p>
            This is a simple quiz application using HTML/CSS and JavaScript via
            jQuery. I use jQuery to manipulate the DOM in order to:
          ...
          <div className="githublist">
            <div>
              <a
                id="githubLink"
                className="repoLinks"
                href="https://github.com/rmac2289/quizApp"
                target="_blank"
            ...
            <div>
              <a
                className="repoLinks"
                href="https://rmac2289.github.io/quizApp/"
                target="_blank"
                rel="noopener noreferrer"
              >
                {"live app"}
